	...
	while (1) {
		...
		switch (comNum) {
			case 0://man
				...
				printf(ConsoleForeLightBlue"cp <filename> <filename> copy a virtual file\n"ConsoleForeDefault);
				printf(ConsoleForeLightBlue"unmount \t\t unmount the already mounted virtual file system\n"ConsoleForeDefault);
